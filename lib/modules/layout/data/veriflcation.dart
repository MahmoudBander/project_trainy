...
class _VeriflcationState extends State<Veriflcation> {
  ...
  Future<void> _loadNationalId() async {
    ...
    final id = prefs.getString('national_id') ?? '';
    if (id.isNotEmpty && mounted) setState(() => _docCtrl.text = id);
  }
  ...
  Future<void> _submit() async {
    ...
    if (docNumber.isNotEmpty || _selectedImage != null) {
      await ApiService().applyForDiscount(
        accountId: accountId,
  ...
  String _categoryLabel() {
    switch (widget.category) {
      case 'Child':
        return 'تذاكر الأطفال (خصم 50%)';
      case 'Senior':
        return 'كبار السن (خصم 50%)';
      case 'Military':
        return 'مجند بالخدمة العسكرية (مجاني)';
      case 'Disabled':
        return 'من ذوي الاحتياجات الخاصة (مجاني)';
      default:
        return 'خصم خاص';
    }
  }
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          ".سيتم مراجعة الطلب قبل تأكيد الحجز",
                          style: TextStyle(
                            fontFamily: "Cairo",
                            fontSize: 16,
                            fontWeight: FontWeight.w400,
