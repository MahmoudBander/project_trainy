...
class ConfirmationRecoveryScreen extends StatefulWidget {
  ...
  const ConfirmationRecoveryScreen({super.key, this.ticketId = 0, this.ticketPrice = 0});

  @override
  State<ConfirmationRecoveryScreen> createState() => _ConfirmationRecoveryScreenState();
}

class _ConfirmationRecoveryScreenState extends State<ConfirmationRecoveryScreen> {
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(_refundAmount != '---' ? _refundAmount : "85% من المبلغ",
                                  style: GoogleFonts.cairo(fontWeight: FontWeight.w700,
                                      fontSize: 20, color: Colors.black)),
                              Text("المبلغ المسترد :",
                                  style: GoogleFonts.cairo(fontWeight: FontWeight.w400,
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                      Text("تنبيه",
                          style: GoogleFonts.cairo(fontSize: 24, fontWeight: FontWeight.w700)),
                      const SizedBox(width: 10),
                      const Icon(Icons.warning, color: Colors.yellowAccent),
                    ]),
                    const SizedBox(height: 18),
                    Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                      Text("قد يتم خصم رسوم ادارية حسب سياسة الاسترداد",
                          style: GoogleFonts.cairo(fontWeight: FontWeight.w400, fontSize: 16)),
                    ]),
                    const SizedBox(height: 16),
                    Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                      Text("أوافق على سياسة الاسترداد",
                          style: GoogleFonts.cairo(fontWeight: FontWeight.w400, fontSize: 15)),
                      const SizedBox(width: 10),
                      Transform.scale(
                        scale: 1.5,
                        child: Checkbox(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: _isChecked
                            ...
                            MaterialPageRoute(builder: (_) => Recoveredscreen()))
                            : null,
                        style: ElevatedButton.styleFrom(
                            backgroundColor: _isChecked ? Colors.black : Colors.grey[300],
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(59))),
                        child: Text("تأكيد طلب الاسترداد",
                            style: GoogleFonts.cairo(fontWeight: FontWeight.w700,
                                fontSize: 24, color: _isChecked ? Colors.white : Colors.black)),
                      ),
                    ),
                    const SizedBox(height: 30),
                    SizedBox(
