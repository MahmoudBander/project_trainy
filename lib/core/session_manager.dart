...
class SessionManager {
  ...
  static Future<int?> getAccountId() async =>
      (await SharedPreferences.getInstance()).getInt(_keyAccountId);
  ...
  static Future<String?> getFromStation() async =>
      (await SharedPreferences.getInstance()).getString(_keyFromStation);
  static Future<String?> getToStation() async =>
      (await SharedPreferences.getInstance()).getString(_keyToStation);
  static Future<String?> getDeparture() async =>
      (await SharedPreferences.getInstance()).getString(_keyDeparture);
  static Future<String?> getArrival() async =>
      (await SharedPreferences.getInstance()).getString(_keyArrival);
  static Future<String?> getTrainName() async =>
      (await SharedPreferences.getInstance()).getString(_keyTrainName);
  static Future<String?> getTripDate() async =>
      (await SharedPreferences.getInstance()).getString(_keyTripDate);
  static Future<String?> getSeatNumber() async =>
      (await SharedPreferences.getInstance()).getString(_keySeatNumber);
  static Future<double?> getTicketPrice() async =>
      (await SharedPreferences.getInstance()).getDouble(_keyTicketPrice);

  // مسح بيانات الجلسة بس — مش التذاكر
